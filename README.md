...
[![tests](https://github.com/ddev/ddev-bosa_a11y/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/ddev/ddev-bosa_a11y/actions/workflows/tests.yml?query=branch%3Amain)
[![last commit](https://img.shields.io/github/last-commit/ddev/ddev-bosa_a11y)](https://github.com/ddev/ddev-bosa_a11y/commits)
[![release](https://img.shields.io/github/v/release/ddev/ddev-bosa_a11y)](https://github.com/ddev/ddev-bosa_a11y/releases/latest)
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.bosa_a11y.yaml](docker-compose.bosa_a11y.yaml) file.
...
3. Globally replace "bosa_a11y" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.bosa_a11y.yaml` with the `docker-compose.*.yaml` for your recipe.
